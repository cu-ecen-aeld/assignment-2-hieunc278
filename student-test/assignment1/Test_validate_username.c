...
void test_validate_my_username()
{
    ...
    char *user_name_from_conf_file = malloc_username_from_conf_file();
    TEST_ASSERT_EQUAL_STRING_MESSAGE(user_name, user_name_from_conf_file,"AESD students, please fix me!");
}
